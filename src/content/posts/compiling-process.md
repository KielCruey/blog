...
We might need to a pit-stop to add more fancy parts to our target racecar. 
Okay, I will stop with the analogies. :smile:
...
They use a virtual machine to create machine code. 
However, we aren't looking into interpreted languages build processes.
...
The -E flag for g++ stop the compilation process at the preprocessor stage.
